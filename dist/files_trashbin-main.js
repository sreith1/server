...
/* harmony import */ var _services_trashbin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/trashbin */ "./apps/files_trashbin/src/services/trashbin.ts");
/**
...
Navigation.register({
  ...
  order: 50,
  sticky: true,
  getContent: _services_trashbin__WEBPACK_IMPORTED_MODULE_2__["default"]
});
...
var client = (0,webdav__WEBPACK_IMPORTED_MODULE_0__.createClient)((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateRemoteUrl)("dav/trashbin/".concat((_getCurrentUser = (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_3__.getCurrentUser)()) === null || _getCurrentUser === void 0 ? void 0 : _getCurrentUser.uid)));
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return _client__WEBPACK_IMPORTED_MODULE_1__["default"].getDirectoryContents((0,path__WEBPACK_IMPORTED_MODULE_0__.join)('/trash', path), {
            details: true
          });
        case 3:
...
/******/ })()
;
//# sourceMappingURL=files_trashbin-main.js.map?v=e5abe7240d5d2dcd7033